...
这时，这个文件就会被转到下一步骤的处理人。
您则可以在“已审核”列表中看到这个申请单，而“待审核”列表中将不出现这个申请单。

#### 驳回

当您不同意审批的申请，您可以选择驳回文件。
- 点击“驳回”选项，选择下一步骤及处理人（如有必要），点击“发送”按钮，即可将该申请文件驳回。

这个文件就会被系统驳回给您指定步骤的处理人，并出现其“待审核”列表中中。可以在“已审核”列表中看到这个申请单，而“待审核”列表中将不出现这个申请单。

如果您想晚些再核准/驳回，可点击“保存”图标，这样这张申请单就仍然在“待审核”列表中。
