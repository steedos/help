...
## 日历
 ...
 - 共享日历: 共享日历是由管理员建立的授权给普通用户的日历，它是授权给您查看或您订阅的日历的集合。
  ...
  共享日历授权查看给您，那么该日历就会出现在您的“共享日历”一栏，私人日历授权查看给您，您还需订阅该日历，那么该日历就会出现在您的“共享日历”一栏。 

  您也可以订阅其他用户的日历（具体见订阅日历一节），该用户同意后，他的个人日历就会出现在您的“共享日历”一栏。
...
## 订阅日历
 ...
 - 在“共享日历”栏，选择您要取消订阅的日历，点击右侧的“…”，在弹出的下拉菜单里，点击“取消订阅”即可。
...
## 手机同步
 ...
 - 苹果手机同步
     ...
     - 输入服务器，用户名和密码。如[https://cn.steedos.com](https://cn.steedos.com)及您使用会议管理的用户名和密码。
     - 点击下一步，连接上服务器，将日历和会议同步到您的设备上即可。
 - 安卓手机同步
     - 下载安卓第三方软件"sol日历"
     - 设置->添加其他日历账户->用户自定义
     - 输入服务器，用户名和密码。如[https:cn.steedos.com/dav](https://cn.steedos.com/dav)及您使用会议管理的用户名和密码。
