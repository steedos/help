...
## 会议安排
 在主界面上，点击任意“+”按钮，或选择按“月”，“周”，“日”查看时，在主界面右侧任意位置单击或拖动都会进入新增会议界面。一个会议主要包含以下几个要素：
  ...
  - 提醒：在会议开始之前可设置时间点提醒，如在会议开始前15分钟提醒您参加会议。新增会议时，我们为您添加了一个默认15分钟前的提醒。
...
## 会议提醒
 本系统的提醒分为三种，弹出框提醒，推送提醒，短信提醒。
 - 弹出框提醒：进入系统后，若您的某个会议已到达提醒时间，则系统会弹出提醒框，你可以选择关闭或延迟提醒。
 - 推送提醒：如果有跟您相关的会议信息，如您被邀请参加会议、您的会议信息有改动或会议取消了，我们都会给您发送推送通知您。同时，我们会根据您的会议提醒时间，在提醒时间到时，给您发送推送。但这些需要您安装我们审批王客户端。
 - 短信提醒：购买专业版的用户可以使用短信提醒功能，在会议详情界面上，提醒选项里选择“立刻发送短信”选项，我们会在新增，修改会议时给所有参与者发送短信；在删除会议时，给已经接受会议邀请的参与者发送短信通知。
 - 提醒规则：为了不给您带来不必要的打扰，系统在您能收到推送通知的前提下，就不给你发送短信通知了。
...
## 日历
 ...
 - 我的日历: 包括系统为每一个使用华炎会议管理系统的用户默认建立的日历（就是您的私人日历，可以修改，但是不可以删除），以用户名命名。此日历的成员和管理员只能是用户自己，且标题是用户名；标题，成员，管理员都不能修改。
 ...
 - 授权查看忙碌状态：私人日历可以授权给他人看您的忙碌状态，就是说您在私人日历上的会议，您授权查看忙碌状态的用户，可以看到您在哪个时间段上有会议安排，但不知道会议内容。
 - 日历的添加与维护：
